...
class FileHelper
{
     ...
     * If not set, the value of [[\cst\Application::language]] will be used.
     * @param string $sourceLanguage the language that the original file is in.
     * If not set, the value of [[\cst\Application::sourceLanguage]] will be used.
     ...
     * @throws InvalidParamException if unable to open directory
     */
     ...
     * @return null|array one of $excludes item as an array with keys: 'pattern', 'flags'
     ...
     * @throws \cst\base\InvalidParamException
