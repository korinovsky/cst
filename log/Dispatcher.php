 ...
 *
 * An instance of Dispatcher is registered as a core application component and can be accessed using `App::$app->log`.
 *
 ...
 * @property Logger $logger The logger. If not set, [[\App::getLogger()]] will be used.
...
class Dispatcher extends Object
{
     ...
     * If not set, [[\App::getLogger()]] will be used.
     * @property Logger the logger. If not set, [[\App::getLogger()]] will be used.
