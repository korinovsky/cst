 ...
 */
abstract class In extends Object
{
    private $_scriptFile;
     ...
     * @var string
     */
    public $controller = '\\app\\controllers\\Main';
    /**
     * @var string
     */
    ...
    {
        $this->route = (array) $this->route;
        if (!isset($this->defaultController)) {
            $this->defaultController = $this->controller;
        }
     ...
     * @return array
     */
    abstract public function parseAction($action);

    /**
     * @param array $parsed
     */
    public function initAction($parsed) {
     ...
     * @param string $scriptFile the entry script file path. This can be either a file path or a [path alias](guide:concept-aliases).
