 ...
 *     throw new \core\web\HttpException(404, 'The requested Item could not be found.');
 * }
 * ```
 */
class HttpException extends UserException
{
    ...
    {
        if (isset(Out::$httpStatuses[$this->statusCode])) {
            return Out::$httpStatuses[$this->statusCode];
        } else {
            return 'Error';
        }
    }
