...
class ColumnSchemaBuilder extends Object
{
    ...
    /**
     * @var \cst\db\Connection the current database connection. It is used mainly to escape strings
     ...
     * @param \cst\db\Connection $db the current database connection. See [[$db]].
