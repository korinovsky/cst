 ...
 *
 * To declare an ActiveRecord class you need to extend [[\cst\db\ActiveRecord]] and
 * implement the `tableName` method:
 *
 * ```php
 * <?php
 *
 * class Customer extends \cst\db\ActiveRecord
 * {
 ...
 *
 * @method ActiveQuery hasMany($class, $link) see [[BaseActiveRecord::hasMany()]] for more info
 * @method ActiveQuery hasOne($class, $link) see [[BaseActiveRecord::hasOne()]] for more info
 */
class ActiveRecord extends BaseActiveRecord
{
    ...
    {
        return App::createObject(ActiveQuery::className(), [get_called_class()]);
    }
    ...
    /**
     * Declares which DB operations should be performed within a transaction.
     ...
     *
     * ```php
     * return self::OP_INSERT; // or self::OP_INSERT | self::OP_UPDATE | self::OP_DELETE;
     * ```
     *
     * @return array the corresponding transaction operations.
     */
    ...
    public function insert($runValidation = true, $attributes = null)
    {
        if ($runValidation && !$this->validate($attributes)) {
            App::info('Model not inserted due to validation error.', __METHOD__);
            return false;
        }
     ...
     * meaning all attributes that are loaded from DB will be saved.
     * @return false|int the number of rows affected, or false if validation fails
    ...
    public function update($runValidation = true, $attributeNames = null)
    {
        if ($runValidation && !$this->validate($attributeNames)) {
            App::info('Model not updated due to validation error.', __METHOD__);
            return false;
        }
