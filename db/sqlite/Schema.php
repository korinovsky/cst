...
namespace cst\db\sqlite;

use cst\base\NotSupportedException;
use cst\db\Expression;
use cst\db\TableSchema;
use cst\db\ColumnSchema;
use cst\db\Transaction;
 ...
 * @since 2.0
 */
class Schema extends \cst\db\Schema
{
    /**
     ...
     * This can be either [[Transaction::READ_UNCOMMITTED]] or [[Transaction::SERIALIZABLE]].
     * @throws \cst\base\NotSupportedException when unsupported isolation levels are used.
