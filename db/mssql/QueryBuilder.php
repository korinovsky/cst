...
use cst\db\Expression;

/**
 * QueryBuilder is the query builder for MS SQL Server databases (version 2008 and above).
 */
class QueryBuilder extends \cst\db\QueryBuilder
{
    /**
     ...
     * @param array $orderBy the order by columns. See [[\cst\db\Query::orderBy]] for more details on how to specify this parameter.
     * @param int $limit the limit number. See [[\cst\db\Query::limit]] for more details.
     * @param int $offset the offset number. See [[\cst\db\Query::offset]] for more details.
    ...
    protected function getAllColumnNames($modelClass = null)
    {
        ...
        /* @var $modelClass \cst\db\ActiveRecord */
