...
use cst\base\InvalidCallException;
use cst\caching\Cache;
use cst\caching\TagDependency;
...
abstract class Schema extends Object
{
     ...
     */
    public $exceptionMap = [
        'SQLSTATE[23' => 'cst\db\IntegrityException',
    ];
    /**
     * @var string column schema class
     * @since 2.0.11
     */
    public $columnSchemaClass = 'cst\db\ColumnSchema';
    ...
    /**
     * @return \cst\db\ColumnSchema|Object
     * @throws \cst\base\InvalidConfigException
     */
    protected function createColumnSchema()
    {
        return App::createObject($this->columnSchemaClass);
    }
    ...
    public function getTableSchema($name, $refresh = false)
    {
        ...
        if ($db->enableSchemaCache && !in_array($name, $db->schemaCacheExclude, true)) {
            /* @var $cache Cache */
            $cache = is_string($db->schemaCache) ? App::$app->get($db->schemaCache, false) : $db->schemaCache;
    ...
    {
        /* @var $cache Cache */
        $cache = is_string($this->db->schemaCache) ? App::$app->get($this->db->schemaCache, false) : $this->db->schemaCache;
    ...
    public function convertException(\Exception $e, $rawSql)
    {
        ...
        $exceptionClass = '\cst\db\Exception';
