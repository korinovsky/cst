 ...
 *
 * ```php
 * App::$app->mailer->compose('contact/html', ['contactForm' => $form])
...
class Mailer extends BaseMailer
{
     ...
     */
    public $messageClass = 'cst\mail\Message';
    /**
     * @var bool whether to enable writing of the SwiftMailer internal logs using App log mechanism.
     ...
     * @throws \cst\base\InvalidConfigException on invalid transport configuration.
     ...
     * @throws \cst\base\InvalidConfigException on invalid configuration.
     */
    protected function createSwiftObject(array $config)
    {
        ...
        if (isset($config['constructArgs'])) {
            ...
            $object = App::createObject($className, $args);
        } else {
            $object = App::createObject($className);
        }
